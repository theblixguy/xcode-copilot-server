...
describe("OpenAI provider", () => {
  ...
  it(
    "rejects requests with wrong user-agent",
    async () => {
  ...
  it(
    "rejects requests with missing user-agent",
    async () => {
  ...
  it(
    "strips excluded file code blocks from prompt",
    async () => {
      mock.history.clear();
      const server = await startServer(openaiProvider, byok(), {
